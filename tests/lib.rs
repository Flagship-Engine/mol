...
fn load_cube_vn() {
    ...
    let expected = [
        (Vec3::from([1.0, 1.0, -1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 1.0, 0.0])),
        (Vec3::from([-1.0, 1.0, -1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 1.0, 0.0])),
        (Vec3::from([-1.0, 1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 1.0, 0.0])),
        (Vec3::from([1.0, 1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 1.0, 0.0])),
        (Vec3::from([1.0, -1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 0.0, 1.0])),
        (Vec3::from([1.0, 1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 0.0, 1.0])),
        (Vec3::from([-1.0, 1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 0.0, 1.0])),
        (Vec3::from([-1.0, -1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, 0.0, 1.0])),
        (Vec3::from([-1.0, -1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([-1.0, 0.0, 0.0])),
        (Vec3::from([-1.0, 1.0, 1.0]), Vec2::from([0.0, 0.0]), Vec3::from([-1.0, 0.0, 0.0])),
        (Vec3::from([-1.0, 1.0, -1.0]), Vec2::from([0.0, 0.0]), Vec3::from([-1.0, 0.0, 0.0])),
        (Vec3::from([-1.0, -1.0, -1.0]), Vec2::from([0.0, 0.0]), Vec3::from([-1.0, 0.0, 0.0])),
        (Vec3::from([-1.0, -1.0, -1.0]), Vec2::from([0.0, 0.0]), Vec3::from([0.0, -1.0, 0.0])),
